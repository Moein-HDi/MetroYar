...
a12l1 = Station('شهدای هفت تیر1', ['l1'])
...
c11l3 = Station('میدان ولیعصر1', ['l3'])
...
subway2.add_connection(a11, a12l1, 2)
subway2.add_connection(a12l1, a13, 3)
...
subway2.add_connection(c10l3, c11l3, 4)
subway2.add_connection(c11l3, c12, 3)
...
subway2.add_connection(a12, a12l1, 1000)
subway2.add_connection(a12, a12l6, 1000)
subway2.add_connection(a12l1, a12l6, 1000)
...
subway2.add_connection(c11, c11l3, 1000)
subway2.add_connection(c11, c11l6, 1000)
subway2.add_connection(c11l3, c11l6, 1000)
